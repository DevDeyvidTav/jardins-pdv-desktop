...
export function serializarProduto(produto: Produto): Record<string, unknown> {
  return {
    ...
    fiscalCest: produto.fiscalCest,
    fiscalCfop: produto.fiscalCfop,
    fiscalIcmsOrigem: produto.fiscalIcmsOrigem,
    fiscalIcmsCsosn: produto.fiscalIcmsCsosn,
    fiscalPisCst: produto.fiscalPisCst,
    fiscalCofinsCst: produto.fiscalCofinsCst,
